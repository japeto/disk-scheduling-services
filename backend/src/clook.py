def clook(arm_position, lrequests, debug=False):
    """
    C-LOOK (Circular LOOK) implementation.
    ...
    # Sequence of movements: first to the right, then wrap around to the lowest
    sequence = requests_right + requests_left
...
# Ejemplo de uso
result = clook(96, [125, 17, 23, 67, 90, 128, 189, 115, 97], debug=True)
print(result)
